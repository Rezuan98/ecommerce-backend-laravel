...
<section id="new-arrivals-section" class="new-arrivals-products">
    <div class="container mt-4">
        <h2 class="section-title" style="text-align: center;">New Arrival Products</h2>
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-md-2-4 col-lg-2-4 ">
                        <div class="new-arrival-box">
                            ...
                            <div class="new-arrival-image">
                                ...
                                <button onclick="addToCartFromNewArrivals({{ $product->id }}, {{ $product->variants->first()->id }}, {{ $final_price }})" class="plus-btn" title="Add to Cart">
...
async function addToCartFromNewArrivals(productId, variantId, price) {
    try {
