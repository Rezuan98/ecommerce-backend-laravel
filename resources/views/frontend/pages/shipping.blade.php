...
<div class="container py-5">
    <div class="row">
        ...
        name="city" 
        id="deliveryLocation">
    <option value="{{ $deliveryCharge1->charge }}" {{ old('city') == 'inside' ? 'selected' : '' }}>
        Inside Dhaka (৳{{ $deliveryCharge1->charge }})
    </option>
    <option value="{{ $deliveryCharge2->charge }}" {{ old('city') == 'outside' ? 'selected' : '' }}>
        Outside Dhaka (৳{{ $deliveryCharge2->charge }})
    </option>
</select>
                                @error('city')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="payment-method-card">
                                            ...
                                            <label class="btn btn-outline-secondary w-100 h-100" for="cod">
                                                <img src="{{ asset('frontend/images/cod.jpg') }}" 
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="border-top pt-3">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <span>Shipping</span>
                            <span id="shippingCost">৳{{ number_format($deliveryCharge1->charge, 2) }}</span>
                        </div>
                        {{-- <div class="d-flex justify-content-between mb-2">
                            <span>Tax (10%)</span>
                            <span>৳{{ number_format($cartItems->sum(function($item) {
